...
function parallax_frame_get_default_theme_options() {
	...
	$default_theme_options = array(
		...
		'footer_sidebar_area_background_image'			   => get_template_directory_uri() . '/images/gallery/supplementary-bg.jpg',
		...
		'featured_content_background_image'                => get_template_directory_uri() . '/images/gallery/bg-featured-content.jpg',
		...
		'logo_slider_bg'                                   => get_template_directory_uri() . '/images/gallery/bg-logo-slider.jpg',
