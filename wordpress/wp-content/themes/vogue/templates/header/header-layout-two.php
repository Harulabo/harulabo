...
<header id="masthead" class="site-header site-header-two <?php echo ( !get_theme_mod( 'vogue-header-search' ) ) ? '' : sanitize_html_class( 'header-no-search' ); ?> <?php echo ( get_theme_mod( 'vogue-header-density' ) == 'vogue-header-density-compact' ) ? sanitize_html_class( 'site-header-compact' ) : ''; ?> <?php echo ( get_theme_mod( 'vogue-remove-header-lines' ) ) ? sanitize_html_class( 'header-no-lines' ) : ''; ?>">
	...
	<div class="site-main-bar">
		<div class="site-container">
			...
			<div class="site-sub-bar">
				...
				<?php if ( !get_theme_mod( 'vogue-header-search' ) ) : ?>
	...
	<?php if ( get_theme_mod( 'vogue-plugin-mega-menu' ) ) : ?>
		<nav class="main-navigation-mm">
		    <?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'primary-menu' ) ); ?>
		</nav><!-- #site-navigation -->
	<?php else : ?>
		<nav id="site-navigation" class="main-navigation <?php echo ( get_theme_mod( 'vogue-set-sticky-header' ) ) ? sanitize_html_class( 'stick-header' ) : ''; ?> <?php echo ( get_theme_mod( 'vogue-mobile-nav-skin' ) ) ? sanitize_html_class( get_theme_mod( 'vogue-mobile-nav-skin' ) ) : sanitize_html_class( 'vogue-mobile-nav-skin-dark' ); ?>" role="navigation">
